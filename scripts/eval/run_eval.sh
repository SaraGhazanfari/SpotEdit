...
cd models/BAGEL
/scratch/sg7457/code/SpotEdit/pytorch-example/python edit_inference.py --mode dreamedit
...
# cd models/UNO
# /scratch/sg7457/code/SpotEdit/pytorch-example/python edit_inference.py --mode real
